document.addEventListener('DOMContentLoaded', () => {
    ...
    window.borrowBook = async function(studentId, bookId){
        window.location.href = `/student/borrow/index.html?bookId=${bookId}&studentId=${studentId}`
    }
    window.profileLink = async function(){
        window.location.href = `/student/profile/index.html?studentId=${studentId}`
    }
        ...
        try {
            ...
            books.forEach(book => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button id='borrow' class ='borrow-btn' onclick="borrowBook('${studentId}','${book._id}')">Borrow</button>
                    </td>
                `;
    ...
    profile.addEventListener("click",profileLink)

    fetchBooks(); //calling profile page
});